...
public class sample1 {
	...
	public static void main(String[] args) {
		...
		//List 컬랙션을 Set 컬랙션으로 변환
		s = new HashSet<Integer>(lst);
		System.out.println(s);
		
		//데이터 저장 순서가 입력한 그대로 출력되게 
		...
		Set<Integer> treeSet = new LinkedHashSet<Integer>(s);
		treeSet.add(40); treeSet.add(50); treeSet.add(60);
