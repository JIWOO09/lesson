...
public class Sample1 {
	...
	public static void main(String[] args) {
		...
		p[1] = new StudentB();
		p[1].setName("박찬호");	p[1].setAge(17);	p[1].setGender('남');
		
		p[2] = new StudentC();
		p[2].setName("김연아");	p[2].setAge(18);	p[2].setGender('여');
		
		p[3] = new StudentA();
		p[3].setName("손흥민");	p[3].setAge(19);	p[3].setGender('남');
		
		p[4] = new StudentB();
		p[4].setName("최유정");	p[4].setAge(17);	p[4].setGender('여');
