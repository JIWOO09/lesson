...
public class Operator {
	...
	public static void main(String[] args) {
		...
		boolean c4 = a < b; //b가 큰지 비교
		boolean c5 = a >= b; //a가 크거나 같거나 비교
		boolean c6 = a <= b; //b가 크거나 같거나 비교
		...
		boolean s5 = s2.equals("abcd"); //문자열 비교는 항상 equals로 
		boolean s6 = s1.equals("abcd"); //문자열 비교는 항상 equals로 
